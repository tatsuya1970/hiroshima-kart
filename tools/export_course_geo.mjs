...
const geojson = {
  ...
  name: 'Hiroshima Kart course',
  features: [
    {
      type: 'Feature',
      properties: { name: '広島グランプリ コース', length_m: cp.length, stroke: '#e63946', 'stroke-width': 5 },
...
<gpx version="1.1" creator="Hiroshima Kart" xmlns="http://www.topografix.com/GPX/1/1">
  <metadata><name>広島グランプリ コース</name><desc>1周 ${cp.length}m</desc></metadata>
${labels.map(l => `  <wpt lat="${r6(l.ll[0])}" lon="${r6(l.ll[1])}"><name>${l.name}</name></wpt>`).join('\n')}
  <trk><name>広島グランプリ コース</name><trkseg>
...
<kml xmlns="http://www.opengis.net/kml/2.2"><Document>
  <name>広島グランプリ コース</name>
  <description>Hiroshima Kart / 1周 ${cp.length}m</description>
