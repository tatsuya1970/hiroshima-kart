...
//   PORT=5180 node tools/make_ogp.mjs
//
// 1200x630 でゲームを開き、HUD を隠して原爆ドーム前の画をつくり、
...
/** 経由地 8 = 原爆ドーム前。cam=3 は寄りのカメラ */
const QUERY = process.env.QUERY ?? 'debug=1&wp=8&cam=3&nofps=1&q=high';
const OUT = process.env.OUT ?? 'public';
mkdirSync(OUT, { recursive: true });

const CARDS = [
  { file: 'ogp.png', title: 'HIROSHIMA KART', sub: '広島グランプリ', lead: 'PLATEAU の3D都市モデルで走る、実在の広島の街', foot: 'ブラウザで、いますぐ　/　インストール不要　/　最大8人のオンライン対戦' },
  { file: 'ogp-en.png', title: 'HIROSHIMA KART', sub: 'Hiroshima Grand Prix', lead: 'The real city of Hiroshima, from MLIT’s Project PLATEAU', foot: 'Play in your browser  /  no install  /  online multiplayer for up to 8' },
];
